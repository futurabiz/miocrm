...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Nuovo Contatto</h1>
    ...
    <form action="{{ route('contacts.store') }}" method="POST" data-address-form="true">
        @csrf
...
$(document).ready(function() {
    ...
    initializeSelect2('#field-company_id', "{{ route('api.companies.search') }}", '-- Cerca Azienda... --');
    initializeSelect2('#field-city_code', "{{ route('api.cities.search') }}", '-- Cerca comune di nascita... --');
