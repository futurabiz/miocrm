    ...
    <tbody>
        @forelse($opportunities as $opportunity)
            <tr>
                ...
                <td class="text-end">
                    {{-- Rotta corretta: opportunities.show --}}
                    <a href="{{ route('opportunities.show', $opportunity->id) }}" class="btn btn-info btn-sm">Visualizza</a>
                </td>
            </tr>
        @empty
            <tr>
                <td colspan="5" class="text-center">Nessuna opportunità collegata a questo contatto.</td>
            </tr>
        @endforelse
    </tbody>
</table>
{{-- Rotta corretta: opportunities.create --}}
<a href="{{ route('opportunities.create', ['contact_id' => $contatto->id]) }}" class="btn btn-primary btn-sm mt-2">
